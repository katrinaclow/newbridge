...
{{--                <a href="{{ url('/register') }}" style="opacity: 0.5;">Register</a> --}}
    ...
    <div class="content">
        ...
        <div class="links">
            ...
            <a href="https://open.spotify.com/artist/4oK0n4XsTRe1G3JBSlT6g1?si=Mm2tt6eyQk65_6P7fqB-UA">Spotify</a>
...
<div id="bio" class="bio content">
    ...
    <div class="links">
        ...
        <a href="https://open.spotify.com/artist/4oK0n4XsTRe1G3JBSlT6g1?si=z_rXHu5HSYSFWTWXC86WZg">Spotify</a>
        <a href="https://www.facebook.com/profile.php?id=61563267180532">Faceboook</a>
{{--        <a href="#contact">Twitter</a>--}}
    </div>
</div>
...
<section class="bg-transparent">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <div class="flex justify-center mt-8 space-x-6">
            ...
            <a href="https://open.spotify.com/artist/your-spotify-id" class="text-gray-400 hover:text-gray-500">
